...
export default function ImmigrationLawPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white font-sans antialiased">
      ...
      <main>
        <section className="px-6 md:px-12 lg:px-24 max-w-[1440px] mx-auto pt-12 pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mb-16">
            <div>
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-[#D4C5A9] tracking-tight leading-[1.1]">
                Immigration<br />Law
              </h1>
            </div>
          ...
          <div className="relative w-full aspect-[21/9] rounded-3xl overflow-hidden bg-zinc-900 group">
            <Image
        ...
        <section className="px-6 md:px-12 lg:px-24 max-w-[1440px] mx-auto pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <div>
                ...
                <div className="space-y-12">
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-medium mb-4">Visa Services</h3>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-[#A3A3A3] leading-relaxed">
                        ...
                        becoming a citizen. We provide support for
                        applications, interviews, and potential legal challenges
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-12 bg-[#121212] border border-[#262626] p-8 md:p-10 rounded-3xl">
                <h3 className="text-2xl font-medium mb-2">Book a Consultation</h3>
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input
                      className="w-full bg-zinc-900 border border-[#262626] rounded-xl px-4 py-3 text-white focus:ring-[#D4C5A9] focus:border-[#D4C5A9] placeholder-zinc-600"
                  ...
                  <div>
                    ...
                    <select className="w-full bg-zinc-900 border border-[#262626] rounded-xl px-4 py-3 text-white focus:ring-[#D4C5A9] focus:border-[#D4C5A9]">
