  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white font-sans antialiased">
      ...
      <section className="pt-16 pb-12 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="mt-16 relative aspect-video w-full rounded-3xl overflow-hidden bg-zinc-900 group">
          <Image
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 leading-relaxed">
                    ...
                    filings, providing robust protection for your inventions
          ...
          <div className="lg:col-span-5">
            <div className="lg:sticky lg:top-32 bg-zinc-900/50 border border-white/10 p-10 rounded-3xl">
              <h3 className="text-2xl font-medium mb-2">Request a Consultation</h3>
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 focus:border-[#D4C5A9] focus:ring-0 transition-colors text-white"
